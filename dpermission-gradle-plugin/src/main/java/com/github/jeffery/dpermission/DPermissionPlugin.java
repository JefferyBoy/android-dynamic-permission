package com.github.jeffery.dpermission;
 ...
 * @date 2022/9/20
 */
public class DPermissionPlugin implements Plugin<Project> {

    @Override
    public void apply(Project project) {
        PluginContainer plugins = project.getPlugins();
        final Logger log = project.getLogger();
        log.debug("config dpermission for project " + project.getName());
